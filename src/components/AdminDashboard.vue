    ...
    <div class="bg-white p-6 rounded-lg shadow">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <router-link to="/customers" 
          ...
          <span class="font-medium text-gray-900">Kelola Pelanggan</span>
        </router-link>
        ...
        <router-link to="/branches" 
          ...
          <span class="font-medium text-gray-900">Kelola Cabang</span>
        </router-link>
        ...
        <router-link to="/vouchers" 
          ...
          <span class="font-medium text-gray-900">Kelola Voucher</span>
        </router-link>
        ...
        <router-link to="/transactions" 
          ...
          <span class="font-medium text-gray-900">Kelola Transaksi</span>
        </router-link>
      </div>
    </div>
  </div>
