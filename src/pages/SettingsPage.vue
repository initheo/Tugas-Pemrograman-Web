        ...
        <div class="p-6">
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div class="flex items-center justify-between">
              ...
              <button class="px-3 py-1 text-xs font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded hover:bg-gray-200">
                Enable
              </button>
            </div>
            ...
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-xs text-gray-600">Get notified when someone logs into your account</p>
              </div>
            ...
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-xs text-gray-600">Manage your active login sessions</p>
              </div>
              <button class="px-3 py-1 text-xs font-medium text-red-700 bg-red-100 border border-red-300 rounded hover:bg-red-200">
                View Sessions
              </button>
            </div>
            ...
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-xs text-gray-600">Download a copy of your data</p>
              </div>
              <button class="px-3 py-1 text-xs font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded hover:bg-gray-200">
                Export
              </button>
